...
class Pendulum:
    """Pendulum environment. This implementation allows multiple poles,
    ...
    def __init__(self, visual=False):
        ...
        self.delta_time = 0.01      # time step of the Euler integrator - HIK: modified to 0.01 (from 0.1)
        self.max_force = 20.
        self.gravity = 9.8
        self.cart_mass = 0.5
    ...
    def performAction(self, action = 0.0):
        ...
        for step in range(self.sim_steps):
            ...
            cart_accel = jnp.array(0.0)

            pole_accel = (-3.0*c*(2.0/self.pole_length)*(self.pole_length/2.0*self.pole_mass*(self.pole_velocity**2)*s)+\
